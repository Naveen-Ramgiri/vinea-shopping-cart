...
import '../../ProductListing/WomenProductListing/Productlisting.css';
...
import sliders from '../AllProducts/sliders.png';
            ...
            <div className="aem-Grid aem-Grid--12">
              <div className="aem-GridColumn aem-GridColumn--default--3">
                <div className="productfilters">
                  <h4>Filters</h4>
                  <p>Sizes</p>
                  <label><input type="checkbox" onChange={(e) => filterHandler(e.target, "/jewellery")} checked={pathname == "/jewellery"} id="option" name="option" value="option" />Jewellery</label>
                  <label><input type="checkbox" onChange={(e) => filterHandler(e.target, "/electronics")} checked={pathname == "/electronics"} id="option" name="option" value="option" />Electronics</label>
                  <label><input type="checkbox" onChange={(e) => filterHandler(e.target, "/men")} checked={pathname == "/men"} id="option" name="option" value="option" />Men's Clothing</label>
                  <label><input type="checkbox" onChange={(e) => filterHandler(e.target, "/women")} checked={pathname == "/women"} id="option" name="option" value="option" />Women's Clothing</label>
                </div>
              </div>
              <div className="aem-GridColumn aem-GridColumn--default--9 aem-GridColumn--phone--12">
                <AllProduct />
